        ...
        />
          ...
          <main className="flex-1 py-12">
            ...
            <p className="text-lg text-gray-700 mb-8">
              ...
              journal articles, and scholarly contributions
              in ageing, childhood studies, education,
            ...
            <div className="space-y-10">
              {currentItems.map((item) => (
                ...
                >
                  ...
                  {/* DETAILS */}
                  {selectedItem === item.id && (
                    <div className="mt-6 bg-amber-50/40 p-5 rounded-lg border-l-4 border-amber-600">
